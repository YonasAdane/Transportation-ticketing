...
/*        form{
    ...
    <body>
        ...
        <div >
            ...
            <button id="upd" >To UPDATE</button>
        </div>
          <%  }
        %>
        
        <main class="main-container">
            <form id="myForm" action="ADDbus" method="post" class="aside">
                <h2 id="formTitle">ADD BUS</h2>
                <div class="userN">
                    <label for="default">BusID</label>
                    <input id="textInput" type="text" name="default" readonly>                </div>
                <div class="userN">
                    <label for="UserName">BusLevel</label>
                    <input type="text" name="BusLevel"><br>
                </div>
                <div class="userN">
                    <label for="UserName">BusType</label>
                    <input type="text" name="BusType"><br>
                </div>
                <div class="userN">
                    <label for="UserName">LicensePlate</label>
                    <input type="text" name="LicensePlate"><br>
                </div>
                <div class="userN">
                    <label for="Address">CurrentCity</label>
                    <input type="text" name="CurrentCity"><br>
                </div>
                <div class="userN">
                    <label for="UserPassword">TotalSeats</label>
                    <input type="text" name="TotalSeats"><br>
                </div>
               <div class="userN">
                    <label for="UserPassword">DestinationCity</label>
                    <input type="text" name="DestinationCity"><br>
                </div>
                <div class="userN">
                    <input type="submit" id="lastButton" class="submit" value="ADD">
                </div>
            </form>
            <form class="main" action="DELETEbus" method="post"  >
